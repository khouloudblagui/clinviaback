...
@RestController
@CrossOrigin(origins = "*")
@RequestMapping("api/v1/parameterization/medication")
public class MedicationController {
    ...
    @PostMapping("/by-ids")
    public ResponseEntity<List<Medication>> getMedicationsByIds(@RequestBody List<Integer> ids) {
        List<Medication> medications = MSer.getMedicationsByIds(ids);
