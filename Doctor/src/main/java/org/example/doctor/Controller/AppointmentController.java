...
public class AppointmentController {
 ...
 /*       Optional<Doctor> optionalDoctor = doctorService.getDoctorByUserKy(appointmentDTO.getDoctorId());
    ...
    public Map<String, Long> getAppointmentsLastSixMonths() {
        return appointmentService.getAppointmentsLastSixMonths();
    }
    ...
    @GetMapping("/doctor-userKy/{userKy}")
    public ResponseEntity<List<Appointment>> getAppointmentsByDoctorUserKy(@PathVariable Integer userKy) {
        List<Appointment> appointments = appointmentService.getAppointmentsByDoctorUserKy(userKy);
